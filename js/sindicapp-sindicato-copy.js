...
(function () {
    ...
    window.SINDICAPP_SINDICATO_COPY = {
        ie: {
            ...
            coordSubs: { afiliadas: 'Members', casos: 'Cases', objetivos: 'Objectives', campanas: 'Campaigns', finanzas: 'Finances', comunicaciones: 'Comms', calendario: 'Calendar', documentos: 'Documents', datos: 'Databases', fuentes: 'Data sources', estructura: 'Structure', intake: 'Intake', asambleas: 'Assemblies' },
            ...
            crmObjetivosIntro: 'Objectives of the organisation — a repo of collective goals, their status and progress. These are the union’s own goals, not members’ cases.',
            crmObjEstados: { abierto: 'Open', conseguido: 'Achieved' },
            crmObjPrioridad: { alta: 'High priority', media: 'Medium priority', baja: 'Low priority' },
            crmObjStats: { abiertos: 'open', conseguidos: 'achieved', hitos: 'milestones' },
            crmObjOwnerLabel: 'Commission',
            crmObjHitoLabel: 'Milestone',
            crmObjMetaLabel: 'Target',
            crmObjUpdatesLabel: 'updates',
            crmObjOpenTitle: 'Open',
            crmObjDoneTitle: 'Achieved',
            crmObjCloseBtn: '✓ Mark achieved',
            crmObjReopenBtn: '↺ Reopen',
            crmObjEmpty: 'No objectives yet.',
            sector: 'Sector',
        ...
        es: {
            ...
            viviendaAgendaTitle: 'Agenda',
            coordSections: { admin: 'Admin', wiki: 'Wiki' },
            coordSubs: { afiliadas: 'Afiliadas', casos: 'Casos', objetivos: 'Objetivos', campanas: 'Campañas', finanzas: 'Finanzas', comunicaciones: 'Comunicaciones', calendario: 'Calendario', documentos: 'Documentos', datos: 'Bases de datos', fuentes: 'Fuentes de datos', estructura: 'Estructura', intake: 'Intake', asambleas: 'Asambleas' },
            ...
            crmObjetivosIntro: 'Objetivos de la organización — un repositorio de metas colectivas, su estado y su progreso. Son los objetivos de la organización en sí, no los casos de las afiliadas.',
            crmObjEstados: { abierto: 'Abierto', conseguido: 'Conseguido' },
            crmObjPrioridad: { alta: 'Prioridad alta', media: 'Prioridad media', baja: 'Prioridad baja' },
            crmObjStats: { abiertos: 'abiertos', conseguidos: 'conseguidos', hitos: 'hitos' },
            crmObjOwnerLabel: 'Comisión',
            crmObjHitoLabel: 'Hito',
            crmObjMetaLabel: 'Meta',
            crmObjUpdatesLabel: 'actualizaciones',
            crmObjOpenTitle: 'Abiertos',
            crmObjDoneTitle: 'Conseguidos',
            crmObjCloseBtn: '✓ Marcar conseguido',
            crmObjReopenBtn: '↺ Reabrir',
            crmObjEmpty: 'Sin objetivos todavía.',
